...
2. Configure [trusted publishing](https://docs.pypi.org/trusted-publishers/) on each PyPI project (GitHub owner `KanakMalpani`, workflow `publish.yml`), **or** add **`PYPI_API_TOKEN`** to repo secrets.
